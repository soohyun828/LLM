...
def eval_model(args):
    ...
    if args.descriptor_type == 'spatio':
        qs = f'Please give me a long list of descriptors for action: {label}, {args.N_s} descriptors in total.'
    elif args.descriptor_type == 'temporal':
        qs = f'Please give me a long list of decompositions of steps for action: {label}, Nt steps in total'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--descriptor_type", option=['spatio', 'temporal'], type=str, default="spatial")
